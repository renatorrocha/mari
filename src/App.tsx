...
function App() {
  ...
  return (
        ...
        <Button variant="contained" size='large' color='success' sx={{margin:8}} onClick={()=>{ alert('Parabens amor agora vc esta casada comigo (Renato Rocha) Eu te amo muito♥'); }}>Eu quero</Button>
